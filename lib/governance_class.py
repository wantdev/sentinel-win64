...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to wantd "gobject list" output
    ...
    def wantd_serialise(self):
        import wantlib
        return wantlib.SHIM_serialise_for_wantd(self.serialise())
